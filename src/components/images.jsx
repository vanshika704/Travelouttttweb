  ...
  return (
    <>
      <div className="h-[200vh] bg-zinc-800 pt-7">
        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-4 gap-6 px-16">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="#" className="hover:text-lime-200 text-gray-200 font-semibold">
                PHUKET, THAILAND
              </a>
              <a href="#" className="hover:text-purple-500 text-sm text-gray-400 -mt-1">
                78.4K successful visits
              </a>
              <div className="flex flex-row flex-wrap gap-2">
                <a href="#" className="hover:bg-gray-600 text-gray-300 text-xs font-semibold bg-gray-700 px-2 py-1 rounded-full">
                  Book
                </a>
                <a href="#" className="hover:bg-gray-600 text-gray-300 text-xs font-semibold bg-gray-700 px-2 py-1 rounded-full">
                  Budget
        ...
        {/* Section with button and confetti */}
        <section className="overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2 mt-10 mb-10 h-80">
          <div className="p-8 md:p-12 lg:px-16 lg:py-14">
            <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              <h2 className="text-2xl font-bold text-gray-900 md:text-2xl">
